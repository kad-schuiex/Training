sap.ui.define([
		...
		"nl/kadaster/peopleprofile/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("Employeenumber"),
									name: oBindingContext.getProperty("Ename")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all EmployeeDataSet to be able to check for the total amount
